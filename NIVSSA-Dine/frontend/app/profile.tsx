...
type Table = {
  ...
  status: string;
  turnTime: number;
  restaurant: string | TableRestaurant;
};
...
export default function Home() {
  ...
  /*
    IMPORTANT:
    Profile is handled here too.
    So even if any old Profile button
    still calls this function, it will
    NEVER show the Coming Soon popup.
  */
